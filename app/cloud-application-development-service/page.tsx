...
const AboutSection = lazyServiceAboutSection(() =>
  import("@/components/CloudApplicationDevelopmentService/AboutSection")
);

export default function CloudApplicationDevelopmentService() {    return (
        <>
        <header className="video-header-block">
        <div className="video-wrap-main-block">
            <video autoPlay muted loop poster="/images/cloud-app-video-thumbnail-new.webp">
                <source src="videos/cloud-app.mp4" type="video/mp4" />
            </video>
            <div className="header-content-wrap d-flex flex-column align-items-center justify-content-center">
                <h1 className="animate-on-load">Cloud Application</h1>
